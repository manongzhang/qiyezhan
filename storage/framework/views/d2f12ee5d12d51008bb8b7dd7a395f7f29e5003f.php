...
<body fnav="1" class="g-acc-bg">
    <div class="marginB" id="loadingPicBlock">
        ...
        <!--商品列表-->
        <div class="goods-wrap marginB" id ="div_img">
...
<div class="footer clearfix">
    <ul>
        ...
        <li class="f_personal"><a href="/center" ><i></i>我的潮购</a></li>
    </ul>
</div>
...
<script>
   $(function(){
    $.leftTime("2019/04/22 23:45:24",function(d){
    if(d.status){
      var objh = $(".pro-state").find('em').eq(0);
      objh.text(d.h);
      var objm = $(".pro-state").find('em').eq(1);
      objm.text(d.m);
      var objs = $(".pro-state").find('em').eq(2);
      objs.text(d.s);
    }
   });
}); 
