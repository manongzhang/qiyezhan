    ...
    <div class="wrapper">
        ...
        <div class="registerCon">
            <ul>
                <li class="accAndPwd">
                    <dl>
                        <s class="phone"></s><input id="userMobile" maxlength="11" type="number" placeholder="请输入您的手机号码" value="" name="tel" />
                        <span class="clear">x</span>
                    </dl>
            <dl><s class="password"></s>
            <input class="pwd" name="pwd"maxlength="11" type="text" placeholder="6-16位数字、字母组成" value="" />
            <input class="pwd" maxlength="11" name="two_pwd" type="password" placeholder="6-16位数字、字母组成" value="" style="display: none" />
                        <span class="mr clear">x</span>
                        <s class="eyeclose"></s>
                    </dl>
                    <dl>
                        <s class="password"></s>
                        <input class="conpwd" maxlength="11" type="text" placeholder="请确认密码" name="pwd" value="" />
                        <input class="conpwd" maxlength="11" type="password" placeholder="请确认密码" value="" name="two_pwd" style="display: none" />
                        <span class="mr clear">x</span>
                        <s class="eyeclose"></s>
                    </dl>

                    <dl>
                        <img src="<?php echo e(captcha_src()); ?>" style="cursor: pointer;width:33%" onclick="this.src='<?php echo e(captcha_src()); ?>'+Math.random()">
                        <input type="text" name="vcode" required lay-verify="required" style="float:right;width:67%" > 
                    </dl>
